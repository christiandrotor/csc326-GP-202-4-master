...
public class APIDiagnosisTest {
    ...
    public void testDiagnoses () throws UnsupportedEncodingException, Exception {
        ...
        // (student) get diagnosis from id and diagnosis list
        mvc.perform( get( "/api/v1/diagnosis/" + dlist.get( 0 ).getId() ) ).andExpect( status().isOk() );
        assertNotNull( mvc.perform( get( "/api/v1/diagnoses" ) ) );
