...
public class APIUserTest {
    ...
    public void testUserAPI () throws Exception {
        ...
        mvc.perform( get( "/api/v1/role" ) ).andExpect( status().isUnauthorized() );
    }

    /**
     * Tests to make sure user is an admin
     */
    @WithMockUser ( username = "admin", roles = { "USER", "ADMIN" } )
    @Test
    public void testAdminRoleAPI () throws Exception {
     ...
     * Tests to make sure user is an admin
     */
    @WithMockUser ( username = "admin", roles = { "USER", "PATIENT" } )
    @Test
    public void testPatientRoleAPI () throws Exception {
        mvc.perform( get( "/api/v1/role" ) ).andExpect( status().isOk() );
    }
     ...
     * Tests to make sure user is an admin
     */
    @WithMockUser ( username = "admin", roles = { "USER", "HCP" } )
    @Test
    public void testHCPRoleAPI () throws Exception {
        mvc.perform( get( "/api/v1/role" ) ).andExpect( status().isOk() );
    }
