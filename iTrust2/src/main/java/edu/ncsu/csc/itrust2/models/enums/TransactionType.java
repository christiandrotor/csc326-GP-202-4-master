...
public enum TransactionType {
     ...
     * AppointmentRequest otherwise updated
     */
    APPOINTMENT_REQUEST_CHANGED ( 1402, "Appointment request was changed", true ),
    /**
     * After acoount blocked out, email will be sent
     */
    ACCOUNT_LOCKOUT_EMAIL ( 1403, "Email notification not sent due to missing email address", true ),
    /**
     * AppointmentRequest otherwise updated
     */
    EMAIL_FAILED ( 1404, "Email notification not sent due to missing email address", true ),
     ...
     */
    PASSWORD_CHANGE_SUCCESS ( 1401, "Successful password change", true ),
    /**
     * Reset request email sent successfully
     */
     ...
     * View Logs
     */
    VIEW_LOGS ( 1301, " Log events viewed", true );
