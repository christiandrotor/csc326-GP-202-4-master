...
public class EmailUtil {
    ...
    public static void sendEmail ( final String addr, final String subject, final String body )
        ...
        // );
        // try {
        // final File f = new File( "src/main/java/email.properties" );
         ...
         */
        final String from = "csc326spring18@gmail.com";
        final String username = "csc326spring18@gmail.com";
        final String password = "software123";
